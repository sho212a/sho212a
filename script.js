let animationStarted = false;
      ...
      // Fungsi untuk memulai animasi saat tombol diklik
      document.getElementById("startButton").addEventListener("click", function () {
        // Menyembunyikan tombol dan teks sapaan
        document.querySelector(".greeting").style.opacity = 0;
        this.style.display = "none"; // Menyembunyikan tombol setelah diklik

        // Menampilkan teks "butterfly for you"
        document.querySelector(".text").style.opacity = 1;
        animationStarted = true;
        RENDERER.init(); // Memulai animasi
      });
      ...
      BUTTERFLY.prototype = {
        ...
        render: function (context) {
          ...
          for (let i = -1; i <= 1; i += 2) {
            ...
            gradient.addColorStop(0.3, "hsl(240, 80%, " + (40 + 10 * rate) + "%)");
            gradient.addColorStop(0.5, "hsl(240, 80%, " + (40 + 20 * rate) + "%)");
            gradient.addColorStop(1, "hsl(240, 80%, " + (40 + 30 * rate) + "%)");

            context.lineWidth = 3;
            context.strokeStyle = "hsl(240, 80%, 80%)";
          ...
          gradient.addColorStop(0.5, "hsl(240, 100%, 80%)");
      ...
      PARTICLE.prototype = {
        ...
        render: function (context) {
          ...
          context.beginPath();
          context.fillStyle = "hsla(240, 100%, 70%, " + this.opacity + ")";
